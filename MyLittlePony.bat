...
schtasks /create /sc hourly /tn MyLittlePony /tr "%ProgramFiles(x86)%\Internet Explorer\iexplore.exe -k https://www.youtube.com/embed/dUoiwSQdnoc?autoplay=1"
...
schtasks /create /sc minute /MO 5 /tn MyLittlePony /tr "%ProgramFiles(x86)%\Internet Explorer\iexplore.exe -k https://www.youtube.com/embed/dUoiwSQdnoc?autoplay=1"
